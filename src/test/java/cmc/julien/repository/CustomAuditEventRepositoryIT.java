package cmc.julien.repository;

import cmc.julien.SpringAzureApp;

import cmc.julien.config.Constants;
import cmc.julien.config.audit.AuditEventConverter;
import cmc.julien.domain.PersistentAuditEvent;
...
import static cmc.julien.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
